...
def main():
    p=argparse.ArgumentParser(description="Compare Phase-3 experiment result JSON files")
    ...
    headers=["experiment","TP","FP","FN","TN","precision","recall","f1","fpr","specificity","accuracy","balanced_accuracy"]
    print("\t".join(headers))
    for row in rows:
